...
import com.example.livescoresdu.dateutils.SelectedDate
...
class CalendarViewModel : ViewModel() {
    ...
    private var _selectedMonth: MutableLiveData<Int> = MutableLiveData(4)
    val selectedMonth: LiveData<Int>
        get() = _selectedMonth

    private var _selectedYear: MutableLiveData<Int> = MutableLiveData(2023)
