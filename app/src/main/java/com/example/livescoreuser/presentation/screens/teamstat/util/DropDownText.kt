...
fun DropDownText(
    ...
    modifier: Modifier,
    hint: String = "",
    paddingStart: Dp = spacing16,
    paddingTop: Dp = spacing16,
    paddingEnd: Dp = spacing16,
    paddingBottom: Dp = spacing16,
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = com.example.livescore.R.drawable.ic_drop_down),
